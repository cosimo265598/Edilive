...
QT_MOC_LITERAL(3, 27, 7) // "clicked"

    },
    "FileHandler\0doubleClicked\0\0clicked"
};
...
void FileHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileHandler::doubleClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FileHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileHandler::clicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FileHandler::doubleClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FileHandler::clicked()
{
